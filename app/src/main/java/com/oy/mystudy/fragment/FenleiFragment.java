package com.oy.mystudy.fragment;
...
import com.oy.mystudy.adapter.LeftAdapter;
import com.oy.mystudy.adapter.RightAdapter;
import com.oy.mystudy.bean.FenLeigjiResponse;
import com.oy.mystudy.bean.SecondListResponse;
...
public class FenleiFragment extends Fragment {
    ...
    private List<FenLeigjiResponse.DataBean> leftDatas = (List<FenLeigjiResponse.DataBean>) new ThreadLocal<List<FenLeigjiResponse.DataBean>>();
        ...
        OkHttpUtils.get()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        Gson gson = new Gson();
                        FenLeigjiResponse fenLeiDingjiResponse = gson.fromJson(response, FenLeigjiResponse.class);

                        List<FenLeigjiResponse.DataBean> data = fenLeiDingjiResponse.getData();
    ...
    private void getSecondList(int pos) {
        FenLeigjiResponse.DataBean dataBean = leftDatas.get(pos);
