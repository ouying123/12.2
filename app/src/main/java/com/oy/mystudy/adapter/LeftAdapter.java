package com.oy.mystudy.adapter;
...
public class LeftAdapter extends RecyclerView.Adapter<LeftAdapter.LeftHoder> implements View.OnClickListener{
    ...
    protected final List<FenLeigjiResponse.DataBean> datas;

    //当前选中的位置
    private int cunrunt_pos;
    private OnItemClickLisener onItemClickLisener;

    public LeftAdapter(Context context, List<FenLeigjiResponse.DataBean> leftDatas) {
    ...
    public void onBindViewHolder(@NonNull LeftHoder leftHoder, int i) {
        ...
        FenLeigjiResponse.DataBean dataBean = datas.get(i);
